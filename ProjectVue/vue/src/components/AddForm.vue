<template>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input 
      v-model="addFormData.soft_skill" type="text" class="form-control" id="inputSoft" placeholder="Enter Soft Skill">
    </div>
    <div class="form-group col-md-3">
      <label for="inputAge">Student Age</label>
      <input 
      v-model="addFormData.umur" type="text" class="form-control" id="inputAge" placeholder="Enter Age">
    </div>
    <div class="form-group col-md-3">
      <label for="inputGender">Gender</label>
      <select v-model="addFormData.jenis_kelamin" id="inputGender" class="form-control">
    ...
    <div class="form-group col-md-6">
      ...
      <input 
      v-model="addFormData.hard_skill" type="text" class="form-control" id="inputHard" placeholder="Enter Hard Skill">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input 
      v-model="addFormData.email" type="email" class="form-control" id="inputEmail">
    </div>
    <div class="form-group col-md-6">
      <label for="inputState">Interest</label>
      <select v-model="addFormData.interest" id="inputState" class="form-control">
        <option selected></option>
  ...
  <div class="form-group">
    ...
    <textarea v-model="addFormData.deskripsi_diri" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
  </div>
